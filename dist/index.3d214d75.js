...
const getDataAndGenerateCSVBuffer = async (address, count, lat, lon)=>{
    try {
        const data = await (0, _apiServiceDefault.default)(address, count, lat, lon);
...
},{"./api.service":"de840","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"de840":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _environmentVariablesJson = require("./environmentVariables.json");
var _environmentVariablesJsonDefault = parcelHelpers.interopDefault(_environmentVariablesJson);
const apiUrl = (0, _environmentVariablesJsonDefault.default).API_URL;
const apiPayload = (0, _environmentVariablesJsonDefault.default).API_PAYLOAD;
...
},{"./environmentVariables.json":"jP7ML","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jP7ML":[function(require,module,exports) {
...
},{}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequiredc2e")
